...
namespace Tychaia
{
    public class RPGWorld : IWorld
    {
        ...
        public void DrawBelow(IGameContext gameContext, IRenderContext renderContext)
        {
            gameContext.Graphics.GraphicsDevice.Clear(Color.Black);
        }

        public void DrawAbove(IGameContext gameContext, IRenderContext renderContext)
        {
            XnaGraphics xna = new XnaGraphics(gameContext);
            xna.DrawStringLeft(8, 8, "FPS: " + gameContext.FPS, "Arial");
        ...
        public bool Update(IGameContext gameContext, IUpdateContext updateContext)
        {
            ...
            {
                (this.Game as RuntimeGame).SwitchWorld<TitleWorld>();
                return false;
            }
            ...
            (gameContext.WorldManager as IsometricWorldManager).Focus(this.m_Player.X, this.m_Player.Y, this.m_Player.Z);
