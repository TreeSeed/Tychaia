...
namespace Tychaia.UI
{
    class TitleButton
    {
        ...
        public TitleButton(LanguageAsset text, Rectangle area, Action onClick)
        {
            this.m_Text = text;
            this.m_Area = area;
        ...
        public void Process(IRenderUtilities renderUtilities, IRenderContext renderContext, MouseState mouse)
        {
            ...
            if (this.m_Area.Contains(mouse.X, mouse.Y))
                renderUtilities.RenderRectangle(
                    renderContext,
                    this.m_Area,
