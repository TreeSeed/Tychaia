...
namespace Tychaia
{
    public class BlockAssetEditor : AssetEditor<BlockAsset>
    {
        ...
        {
            this.m_TopTextureNameTextBox = new TextBox { Text = this.m_Asset.TopTexture == null ? null : this.m_Asset.TopTexture.Name };
            ...
            this.m_BottomTextureNameTextBox = new TextBox { Text = this.m_Asset.BottomTexture == null ? null : this.m_Asset.BottomTexture.Name };
            ...
            this.m_LeftTextureNameTextBox = new TextBox { Text = this.m_Asset.LeftTexture == null ? null : this.m_Asset.LeftTexture.Name };
            ...
            this.m_RightTextureNameTextBox = new TextBox { Text = this.m_Asset.RightTexture == null ? null : this.m_Asset.RightTexture.Name };
            ...
            this.m_FrontTextureNameTextBox = new TextBox { Text = this.m_Asset.FrontTexture == null ? null : this.m_Asset.FrontTexture.Name };
            ...
            this.m_BackTextureNameTextBox = new TextBox { Text = this.m_Asset.BackTexture == null ? null : this.m_Asset.RightTexture.Name };
