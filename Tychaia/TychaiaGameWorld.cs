...
namespace Tychaia
{
    public class TychaiaGameWorld : IWorld
    {
            ...
            IChunkFactory chunkFactory)
        {
            ...
            this.m_Octree = chunkOctreeFactory.CreateChunkOctree();
            chunkFactory.CreateChunk(this.m_DiskLevel, this.m_Octree, 0, 0, 0);
            this.m_Player = new Player(this.m_AssetManager, this.m_RenderUtilities);
