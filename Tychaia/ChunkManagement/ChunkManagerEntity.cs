        ...
        public override void Render(IGameContext gameContext, IRenderContext renderContext)
        {
            ...
            for (var z = -3; z <= 3; z++)
            {
                var chunk = this.GetChunkOrGenerate(this.m_World.ChunkOctree, new Vector3(
                    this.m_World.IsometricCamera.Chunk.X + x * (this.m_ChunkSizePolicy.ChunkCellWidth * this.m_ChunkSizePolicy.CellVoxelWidth),
                    this.m_World.IsometricCamera.Chunk.Y + y * (this.m_ChunkSizePolicy.ChunkCellHeight * this.m_ChunkSizePolicy.CellVoxelHeight),
                    this.m_World.IsometricCamera.Chunk.Z + z * (this.m_ChunkSizePolicy.ChunkCellDepth * this.m_ChunkSizePolicy.CellVoxelDepth)));
