...
namespace Tychaia.ProceduralGeneration
{
    ...
    /// </summary>
    [DataContract]
    public class Layer3DBuildingList : Layer3D
    {
        [DataMember]
        [DefaultValue(0)]
        ...
        public Layer3DBuildingList(Layer soilfertility, Layer oredensity, Layer rareoredensity, Layer militarystrength, Layer secondarybiome, Layer townscatter)
            ...
            for (int i = 0; i < width; i++)
                for (int j = 0; j < height; j++)
                {
                    if (townscatter[i + j * width] == 1)
                    {
                        ...
                        int townsize = this.GetRandomRange(x + i, y + j, 0, 100);
                        ...
                        if (ViableFoodBuildings.Count != 0)
                        {
                            ...
                            selection = this.GetRandomRange(x + i, y + j, 0, ViableFoodBuildings.Count);
                        ...
                        if (ViableOreBuildings.Count != 0)
                        {
                            ...
                            int orevaluecount = 0;
                            selection = this.GetRandomRange(x + i, y + j, 0, ViableOreBuildings.Count);
                        ...
                        if (ViableMilitaryBuildings.Count != 0)
                        {
                            ...
                            selection = this.GetRandomRange(x + i, y + j, 0, ViableMilitaryBuildings.Count);
                        ...
                        if (ViablePrestigeBuildings.Count != 0)
                        {
                            ...
                            selection = this.GetRandomRange(x + i, y + j, 0, ViablePrestigeBuildings.Count);
                        ...
                        if (ViableWaterBuildings.Count != 0)
                        {
                            ...
                            selection = this.GetRandomRange(x + i, y + j, 0, ViableWaterBuildings.Count);
