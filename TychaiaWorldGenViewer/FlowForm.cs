...
namespace TychaiaWorldGenViewer
{
    public partial class FlowForm : Form
    {
        ...
        private void buildingPlacerPlacerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.c_FlowInterfaceControl.AddElementAtMouse(
                new LayerFlowElement(
                    this.c_FlowInterfaceControl,
        ...
        private void c_GeneralAddSmoothMenuItem_Click(object sender, EventArgs e)
        {
            this.c_FlowInterfaceControl.AddElementAtMouse(
               new LayerFlowElement(
                   this.c_FlowInterfaceControl,
        ...
        private void c_3DTerrainAddFormTerrainBasicMenuItem_Click(object sender, EventArgs e)
        {
            this.c_FlowInterfaceControl.AddElementAtMouse(
               new LayerFlowElement(
                   this.c_FlowInterfaceControl,
